                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-3 gap-5">
                                ...
                                <div class="space-y-2.5">
                                    ...
                                    <a href="${pathPrefix}photo-booth-bus.html" class="block text-sm text-gray-700 hover:text-blue-600 transition py-1.5 hover:bg-blue-50 rounded-md px-2 -mx-2">
                                        <span class="font-semibold block mb-0.5">VW Bus Photo Booth</span>
                                        <span class="text-xs text-gray-500 leading-relaxed">Snap, pose, and share—no app required, all online</span>
                                    </a>
                                    ...
                                    <a href="${pathPrefix}photo-booth-sets.html" class="block text-sm text-gray-700 hover:text-blue-600 transition py-1.5 hover:bg-blue-50 rounded-md px-2 -mx-2">
                                        <span class="font-semibold block mb-0.5">Photo Booth Sets</span>
                                        <span class="text-xs text-gray-500 leading-relaxed">Fun and immersive photo booth sets designed to fit your event vision</span>
                                    </a>
                                    ...
                                    <div class="px-5 pb-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="space-y-1 pl-1">
                                                ...
                                                <a href="${pathPrefix}photo-booth-bus.html" class="block text-sm text-gray-700 hover:text-blue-700 hover:bg-blue-50/50 transition-all rounded-lg py-2.5 px-3 font-medium">VW Bus Photo Booth</a>
                                                <a href="${pathPrefix}photo-booth-sets.html" class="block text-sm text-gray-700 hover:text-blue-700 hover:bg-blue-50/50 transition-all rounded-lg py-2.5 px-3 font-medium">Photo Booth Sets</a>
